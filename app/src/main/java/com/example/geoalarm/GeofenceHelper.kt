...
object GeofenceHelper {
    ...
    /**
     * Inspects whether a GPS location reading is generated by a mock provider (GPS Spoofing).
     * Works across modern Android (Android 12+ API 31+) and legacy platforms.
     */
